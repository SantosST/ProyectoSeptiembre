...
public class LoginActivity extends AppCompatActivity implements LoaderCallbacks<Cursor> {
    ...
    private void ObtenerReferencias() {
        mEmailView = findViewById(R.id.edtEmailLogin);
        mPasswordView = findViewById(R.id.edtPswdLogin);
        Registrarse = findViewById(R.id.btnRegistroLogin);
        LoginLogin = findViewById(R.id.btnInicioLogin);
    }

    private void SetearLIsteners() {
        Registrarse.setOnClickListener(Registrarse_click);
        LoginLogin.setOnClickListener(LoginLogin_click);

    }

    private OnClickListener Registrarse_click = new OnClickListener() {
        @Override
        public void onClick(View v) {
            Intent nuevaActivity2 = new Intent(LoginActivity.this, Registro.class);
            startActivity(nuevaActivity2);


        }
    };
    private OnClickListener LoginLogin_click = new OnClickListener() {
        @Override
        public void onClick(View v) {
            Nm = mEmailView.getText().toString();
            pswd = mPasswordView.getText().toString();
            attemptLogin();
    ...
    public class UserLoginTask extends AsyncTask<Void, Void, Boolean> {
        ...
        protected void onPostExecute(final Boolean success) {
            ...
            if (success) {
                //finish(); // esto lo comente porque hace que si el logeo tiene exito te cierre la aplicacion y esa no es la idea
        ...
        private  class MyHttpPostRequest extends AsyncTask<JSONObject, Void, Void> {
            ...
            protected Void doInBackground(JSONObject... parametros) {
                ...
                try {
                  ...
                  //  if (miConexion.getResponseCode() == 200) {
                        ...
                        InputStreamReader lectorRespuesta = new InputStreamReader(cuerpoRespuesta, StandardCharsets.UTF_8);
                        procesarJSONLeido(lectorRespuesta);                        // procesarJSONLeido(lectorRespuesta);
                    /*} else {
                        Log.d("AccesoApi", "ConexionOK");
                    }*/
            ...
            protected void onPostExecute(Void aVoid) {
                ...
                if (LoginExitoso) {
                    Intent nuevaActivity = new Intent(LoginActivity.this, navegacion.class);
            ...
            try
            {
                Log.d("LecturaJson","empezo el array 1");
                    JSONLeido.beginArray();
                        ...
                        if (nombreElementoActual.equals("Conexion")){
                          String Recibido = JSONLeido.nextString();
